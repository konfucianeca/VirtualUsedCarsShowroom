            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Vehicle identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Model = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "Vehicle model"),
                    Condition = table.Column<int>(type: "int", nullable: true),
                    YearOfProduction = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Vehicle production year"),
                    Region = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "Settlement where vehicle is"),
                    Gearbox = table.Column<int>(type: "int", nullable: false, comment: "What type gearbox fitted on the vehicle"),
                    Color = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, comment: "Vehicle color"),
                    Mileage = table.Column<byte>(type: "tinyint", nullable: false, comment: "Total distance driven by car up to now"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Appointment identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppointmentDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date of appointment"),
